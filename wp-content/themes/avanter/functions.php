...
if (!function_exists('loop_columns')) {
	function loop_columns() {
		return of_get_option("columns_per_row_iceberge");;
	}
}
...
woocommerce_related_products(of_get_option("columns_per_row_iceberge"),of_get_option("columns_per_row_iceberge")); // Display 3 products in rows of 3
}
...
function progression_scripts() {
	...
	wp_enqueue_style( 'google-fonts', 'http://fonts.googleapis.com/css?family=Lato:300,400,700', array( 'style' ) );
